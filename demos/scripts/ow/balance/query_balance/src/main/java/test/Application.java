...
import test.functions.QueryBalance;// ！！！请勿修改此文件，此文件由脚本生成
// ！！！请勿修改此文件，此文件由脚本生成
// ！！！请勿修改此文件，此文件由脚本生成
...
// ！！！请勿修改此文件，此文件由脚本生成
        JsonObject res= new QueryBalance().call(args);// ！！！请勿修改此文件，此文件由脚本生成
        // ！！！请勿修改此文件，此文件由脚本生成
...
// ！！！请勿修改此文件，此文件由脚本生成
        ...
        JsonObject resp=new QueryBalance().call(req);// ！！！请勿修改此文件，此文件由脚本生成
        // ！！！请勿修改此文件，此文件由脚本生成
