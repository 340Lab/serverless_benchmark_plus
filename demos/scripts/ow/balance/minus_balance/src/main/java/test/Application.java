...
import test.functions.MinusBalance;// ！！！请勿修改此文件，此文件由脚本生成
// ！！！请勿修改此文件，此文件由脚本生成
// ！！！请勿修改此文件，此文件由脚本生成
...
// ！！！请勿修改此文件，此文件由脚本生成
        JsonObject res= new MinusBalance().call(args);// ！！！请勿修改此文件，此文件由脚本生成
        // ！！！请勿修改此文件，此文件由脚本生成
...
// ！！！请勿修改此文件，此文件由脚本生成
        ...
        JsonObject resp=new MinusBalance().call(req);// ！！！请勿修改此文件，此文件由脚本生成
        // ！！！请勿修改此文件，此文件由脚本生成
